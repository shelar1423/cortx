...
5. Generate the CORTX deployment packages using the instructions provided in [Generating the CORTX packages guide](https://github.com/Seagate/cortx/blob/main/doc/community-build/PI-5/Generate-Cortx-Build-Stack.md).
